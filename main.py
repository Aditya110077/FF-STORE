...
# --- Configuration ---
TOKEN = '8498008126:AAGRnEUpGJkPA5FXzyourGRT_wEZbXDCCWg'# Replace with your actual token
OWNER_ID = 6863389453 # Replace with your Owner ID
ADMIN_ID = 6863389453 # Replace with your Admin ID (can be same as Owner)
YOUR_USERNAME = '@CURRENTTTTTTTT' # Replace with your Telegram username (without the @)
UPDATE_CHANNEL = 'https://t.me/newchannel1109' # Replace with your update channel link
...
ADMIN_COMMAND_BUTTONS_LAYOUT_USER_SPEC = [
    ...
    ["🔒 Lock Bot", "🟢 Run All Codes"], # Changed "Free Mode" to "Running All Code"
...
def create_main_menu_inline(user_id):
    ...
    buttons = [
        ...
        types.InlineKeyboardButton('📞 Contact Owner', url=f'https://t.me/{YOUR_USERNAME.replace("@spideyabd", "")}')
    ]
...
BUTTON_TEXT_TO_LOGIC = {
    ...
    "🟢 Run All Code": _logic_run_all_scripts, # Added
